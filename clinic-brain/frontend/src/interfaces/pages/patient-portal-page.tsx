...
export function PatientPortalPage({ professionalSlug }: PatientPortalPageProps) {
  ...
  const [bookingMode, setBookingMode] = useState<'PRESENCIAL' | 'REMOTO'>('REMOTO')
                ...
                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                  <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                    <input
                      type="radio"
                      name="booking-mode"
                      checked={bookingMode === 'REMOTO'}
                      onChange={() => setBookingMode('REMOTO')}
                    />
                    Remoto (Google Meet)
                  </label>
                  <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                    <input
                      type="radio"
                      name="booking-mode"
                      checked={bookingMode === 'PRESENCIAL'}
                      onChange={() => setBookingMode('PRESENCIAL')}
                    />
                    Presencial
                  </label>
                </div>
